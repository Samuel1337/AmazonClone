            ...
            <div className="splash-container">
                ...
                <div className="splash-row">
                    <div className="box">
                        ...
                        <p>See more at <Link to="/categories/smart_home"><span className="free-returns-text">Smart Home </span></Link></p>
                    </div>
                    <div className="box">
                    ...
                    <div className="box">
                        ...
                        <p>See more at <Link to="/categories/home_garden_tools"><span className="free-returns-text">Home, Garden &#38; Tools </span></Link></p>
                    </div>
                    <div className="box">
                        <h1>Give your best friend a treat</h1>
                        <img className="splash-img" onClick={()=>this.redirect(18)} id="18" src={window.pet_supplies} alt="" />
                        <p>See more at <Link to="/categories/pet_supplies"><span className="free-returns-text">Pet Supplies </span></Link></p>
                    </div>
                </div>
                ...
                <div className="splash-row">
                    <div className="box">
                        ...
                        <p>See more at <Link to="/categories/toys_kids_baby"><span className="free-returns-text">Toys, Kids &#38; Baby </span></Link></p>
                    </div>
                    <div className="box">
                    ...
                    <div className="box">
                        ...
                        <p>See more at <Link to="/categories/food_groceries"><span className="free-returns-text">Food &#38; Groceries </span></Link></p>
                    </div>
                    <div className="box">
                        <h1>Save up on cleaning products</h1>
                        <img className="splash-img" onClick={()=>this.redirect(25)} id="25" src={window.beauty_health} alt="" />
                        <p>See more at <Link to="/categories/beauty_health"><span className="free-returns-text">Beauty &#38; Health </span></Link></p>
                    </div>
                </div>
            </div>
        )
